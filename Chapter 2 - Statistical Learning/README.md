...
- [Chapter 2 - Statistical Learning](#chapter-2---statistical-learning)
- [Overview](#overview)
...
- [Assessing Model Accuracy](#assessing-model-accuracy)
  - [The Reression Setting](#the-reression-setting)
    ...
    - [The Bias-Variance Trade-Off](#the-bias-variance-trade-off)
      ...
      - [Bias-Variance Trafe-Off](#bias-variance-trafe-off)
