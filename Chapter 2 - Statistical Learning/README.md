...
In statistical learning, _**input variables**_ <img src="https://render.githubusercontent.com/render/math?math=(X_{n})"> are typically denoted by _features_, _predictors_, _indepedent variables_ or _variables_ while _**output variable**_ <img src="https://render.githubusercontent.com/render/math?math=(Y)"> often called _dependent variable_ or _response_. $$Y$$
