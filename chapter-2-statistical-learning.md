...
> * _**reducible error**_: Reducible error is the error arising from the mismatch between $$\hat{f}$$ and $$f$$. Can be improved by choosing a better model. Usually caused by [Variance Error](chapter-2-statistical-learning.md#variance-error)/[Bias Error](chapter-2-statistical-learning.md#bias-error).
...
![Tradeoff Between Prediction Accuracy and Model Interpretability](<Chapter 2 - Statistical Learning/img/xkcd-interpretability-vs-flexibility.png>)
