...
```{r echo=FALSE, out.width="85%", fig.cap='Plots of residuals versus predicted (or fitted) values for the Auto data set'}
...
```{r echo=FALSE, out.width="85%", fig.cap='Plots of residuals from simulated time series data sets generated with differing levels of correlation p between error terms for adjacent time'}
...
```{r echo=FALSE, out.width="85%", fig.cap=' Residual plots'}
...
```{r echo=FALSE, out.width="85%", fig.cap='Outlier plots'}
...
```{r echo=FALSE, out.width="85%", fig.cap='Leveraging Observations Plots'}
