...
```{r echo=FALSE, out.width='80%', fig.cap='Regression Line'}
...
```{r echo=FALSE, out.width='80%', fig.cap='A simulated data set'}
...
```{r echo=FALSE, out.width='65%', fig.cap='Sampling Distribution of Test Statistic'}
