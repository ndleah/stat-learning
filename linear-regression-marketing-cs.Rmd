...
```{r echo=FALSE, out.width='65%', fig.cap='he Advertising data set'}
...
```{r echo=FALSE, out.width='65%', fig.cap='More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the Advertising data'}
