...
```{r echo=FALSE, out.width='85%', fig.cap='he Advertising data set'}
...
```{r echo=FALSE, out.width='50%', fig.cap='More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the Advertising data'}
knitr::include_graphics("img/90-Table3.6-1.png")
```
...
```{r echo=FALSE, out.width='65%', fig.cap='For the Advertising data, least squares coefficient estimates of the multiple linear regression of number of units sold on radio, TV, and newspaper advertising budgets.'}
knitr::include_graphics("img/88-Table3.4-1.png")
```
...
```{r echo=FALSE, out.width='60%', fig.cap='More simple linear regression models for the Advertising data'}
knitr::include_graphics("img/82-Table3.1-1.png")
```
...
```{r echo=FALSE, out.width='65%', fig.cap='More simple linear regression models for the Advertising data'}
knitr::include_graphics("img/86-Table3.3-1.png")
```
...
```{r echo=FALSE, out.width='65%', fig.cap= 'A linear regression fit to sales using TV and radio as predictors'}
